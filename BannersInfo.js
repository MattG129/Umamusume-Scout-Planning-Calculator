...
let ItemsInfo = [
  ...
  },
  {
    ...
    GlobalStartDate: moment('30 Apr 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('10 May 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
    Name: 'Mr. C.B. (SSR intelligence)',
  ...
  },
  {
    ...
    GlobalStartDate: moment('20 Apr 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('29 Apr 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
  ...
  },
  {
    ...
    GlobalStartDate: moment('12 Apr 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('20 Apr 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
  ...
  },
  {
    ...
    GlobalStartDate: moment('26 Mar 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('6 Apr 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
  ...
  },
  {
    ...
    GlobalStartDate: moment('22 Mar 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('2 Apr 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
  ...
  },
  {
    ...
    GlobalStartDate: moment('5 Mar 2026', "DD MMM YYYY").toDate(),
    GlobalEndDate: moment('13 Mar 2026', "DD MMM YYYY").toDate()
  },
  {
    Type: BannerTypes['Card'].Value,
